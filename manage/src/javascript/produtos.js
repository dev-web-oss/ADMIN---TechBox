...
export async function carregarProdutosPorCategoria(container, categoriaSelecionada) {
  container.innerHTML = "";
  const categorias = ["Acessorio","Antena","CaboHDMI","CaboDeCelular","CaixaDeSom","Campainha","CapasDeCelular","Carregadores","CartoesDeMemoria","Chaveiros","CoposGarrafas","Ferramentas","FoneDeOuvido","Lanterna", "Marmita","Massageador","MiniCompressor","Mouse","Projetores","Radios","RelogioSmartWatch","Suporte","VideoGame"];
