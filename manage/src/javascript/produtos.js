...
export async function carregarProdutosPorCategoria(container, categoriaSelecionada) {
  container.innerHTML = "";
  const categorias = ["Acessorio","Antena","CaboHDMI","CaboDeCelular","CaixaDeSom","Campainha","CapasDeCelular","Carregadores","CartoesDeMemoria","Chaveiros","CoposGarrafas","Estabilizador","Ferramentas","FoneDeOuvido", "Lanterna", "Marmita","Massageador","MiniCompressor","Mouse","Pilha","Projetores","Radios","RelogioSmartWatch","Tvbox","Suporte","VideoGame"];
